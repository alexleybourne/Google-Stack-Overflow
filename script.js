...
if (canRun) {
  ...
  const colour = window.getComputedStyle(input).getPropertyValue('color');
    ...
    if (i == 1) {
      ...
      ButtonAnimated.innerHTML = `
                <div class="Button-Container">
                    <button class="Google-Button Button" style="color: ${colour}; background-color: ${backgroundColor};">I'm Feeling Lucky</button>
